...
function getInteropBlock(dependencies, varOrConst, interop, externalLiveBindings, freeze, accessedGlobals, _, n, s, t) {
    ...
    for (const { defaultVariableName, imports, id, isChunk, name, namespaceVariableName, reexports } of dependencies) {
        if (!isChunk) {
...
function deconflictImportsEsmOrSystem(usedNames, imports, dependenciesToBeDeconflicted, _interop, _preserveModules, _externalLiveBindings, _chunkByModule, syntheticExports) {
...
function deconflictImportsOther(usedNames, imports, { deconflictedDefault, deconflictedNamespace, dependencies }, interop, preserveModules, externalLiveBindings, chunkByModule) {
    ...
    for (const externalModule of deconflictedNamespace) {
        externalModule.namespaceVariableName = getSafeName(`${externalModule.suggestedVariableName}__namespace`, usedNames);
    }
...
class Chunk$1 {
    ...
    getDependenciesToBeDeconflicted(addDependencies, addNonNamespaces, interop, addDependenciesWithoutBindings) {
    ...
    setIdentifierRenderResolutions({ format, interop }) {
        ...
        deconflictChunk(this.orderedModules, this.getDependenciesToBeDeconflicted(format !== 'system', format !== 'es' && format !== 'system', interop, format === 'amd' || format === 'umd' || format === 'iife'), this.imports, usedNames, format, interop, this.outputOptions.preserveModules, this.outputOptions.externalLiveBindings, this.chunkByModule, syntheticExports, this.exportNamesByVariable, this.accessedGlobalsByScope);
    }
